...
const Button = () => {
  ...
  return (
    <a className="w-full md:w-80 py-5 px-8 flex items-center justify-between rounded-full border border-black mt-8 lg:mt-16 info link arrow-btn xl:hover:px-10 duration-500 lg:hover:w-[22rem] ease-out" href="#">
