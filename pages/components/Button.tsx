...
interface ButtonProps {
  ...
  const Button: React.FC<ButtonProps> = ({ color, text, fullW }) => {
  ...
  return (
    <a className={`w-full ${fullW === true ? 'md:w-full' : 'md:w-80' } py-5 px-8 flex items-center justify-between rounded-full border info link arrow-btn xl:hover:px-10 duration-500 lg:hover:w-[22rem] ease-out ${color === 'white' ? 'text-white border-white' : 'text-black border-black'}`} href="#">
