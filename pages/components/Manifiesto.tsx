...
const Manifiesto = () => {
    ...
    return (
      <div className="fixed bottom-12 right-12 z-40 bg-slate-800 text-white w-96 h-[30rem] rounded-3xl overflow-hidden manifiesto">
        <div className="px-8 py-6 mb-0 flex items-center justify-between z-10 relative">
            <h2 className="text-lg">Our Manifiesto</h2>
            <div className="exit-manifiesto">
                  <Image
                    src="/images/x.svg"
                    alt="Forward logo"
                    className=""
        ...
        <div className="w-[98%] h-[64%] overflow-y-auto px-8 pt-0 pb-6 scrollbar" id='scrollbar'>
         ...
         <div className="absolute bottom-0 left-0 w-full mx-auto flex justify-center items-center py-4 pb-6">
