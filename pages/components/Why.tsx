...
const Why = () => {
    ...
    return (
        ...
        <section className="w-full mx-auto px-6 lg:px-10 xl:px-16 2xl:px-24 py-12 xl:py-24 bg-blue-700 text-white">
            ...
            <div className="flex gap-24 items-center max-w-6xl mx-auto mt-24 mb-16">
                
                <div className="relative">
                    <div className="w-[30rem] h-[30rem] relative rounded-full overflow-hidden">
                        <video
                    ...
                    <div className="w-64 h-64 absolute top-0 right-0 translate-x-7 -translate-y-20">
                        <CircularText/>
                    </div>
                    <span className="w-24 h-24 bg-white absolute bottom-0 left-0 rounded-full translate-x-10 flex items-center justify-center">
                        <Image
                ...
                <div className="">
                    ...
                    <h3 className="text-2xl xl:text-xl 2xl:text-3xl 3xl:text-5xl my-6 info description">Become a part of the Forward Platform as we push the boundaries of growth and innovation.</h3>
